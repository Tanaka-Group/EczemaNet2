...
# @Last Modified time: 2023-02-11 12:09:06
...
def main():
	...
	MODEL_NAME = '/' + SEGMENTATION + '_seg_da_batch2.h5'
	...
	print(MODEL_DIR + '/learning_curve_' + SEGMENTATION + 'batch2.png')
	...
	plt.legend(['Train', 'Test'], loc='upper left')
	# plt.show()
	plt.savefig(MODEL_DIR + '/learning_curve_' + SEGMENTATION + '_batch2.png')
