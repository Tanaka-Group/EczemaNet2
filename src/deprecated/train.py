...
# @Last Modified time: 2023-02-11 12:09:01
...
def main():
    ...
    MODEL_NAME = '/' + SEGMENTATION + '_seg_da_batch4.h5'
    ...
    print(MODEL_DIR + '/learning_curve_' + SEGMENTATION + 'batch4.png')
    ...
    callbacks = [
        keras.callbacks.ModelCheckpoint(MODEL_DIR + MODEL_NAME, save_weights_only=False, save_best_only=True,
                                        mode='min'),
    ...
    plt.legend(['Train', 'Test'], loc='upper left')
    # plt.show()
    plt.savefig(MODEL_DIR + '/learning_curve_' + SEGMENTATION + '_batch4.png')
