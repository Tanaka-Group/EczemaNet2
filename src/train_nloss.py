...
def main():
	...
	MODEL_NAME = '/' + MODEL_PREFIX + '_' + SEGMENTATION + '_ce.h5'
	LC_NAME = '/' + MODEL_PREFIX + '_' + SEGMENTATION + '_ce.png'
	...
	MODEL_DIR = os.path.join(PROJ_DIR, 'output/models/' + SEGMENTATION + '_' + MODEL_PREFIX + "_ce")
	...
	callbacks = [
		...
		keras.callbacks.ReduceLROnPlateau(monitor='val_loss', factor=0.75, patience=20, min_delta=0, min_lr=0.4*LR, mode='min'),
